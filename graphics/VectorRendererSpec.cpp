...
drawTriangle(int x, int y, int w, int h, TriangleOrientation orient) {
	...
	if (w == h) {
		...
		case kTriangleRight:
			if (useClippingVersions)
				drawTriangleVertAlgClip(x, y, newW, newW, (orient == kTriangleLeft), color, Base::_fillMode);
			else
				drawTriangleHorAlg(x, y, newW, newW, (orient == kTriangleLeft), color, Base::_fillMode);
			break;
		case kTriangleAuto:
		default:
			break;
